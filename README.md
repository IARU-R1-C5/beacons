...
10. Antenna polarisation (for each antenna)
11. EIRP for each antenna in dBm
12. Current status (planned, on-the-air)
13. Contact email address of responsible person (by default coordination requester)
14. Contact callsign of responsible person (by default coordination requester)
15. Mode of transmission (CW, MGM, mixed, other), please specify details
16. Frequency stabilization source (OCXO, Rubidium, GPS)
